        ...
        <div className="bg-gradient-to-r from-primary/10 to-primary/5 p-6 border-b">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-bold">{t('about.update_available')}</h2>
                {updateInfo && (
          ...
          {status === 'available' && (
            <>
              <p className="text-sm text-muted-foreground">
                {t('update_dialog.new_version_message')}
              </p>
            ...
            <>
              <div className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  <span className="text-muted-foreground">{t('about.update_downloading')}</span>
              ...
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <span>{t('update_dialog.do_not_close')}</span>
              </div>
            </>
          )}
          ...
          {status === 'downloaded' && (
            <>
              <div className="flex items-center gap-3 text-green-600">
                ...
                <span className="font-medium">{t('update_dialog.download_complete')}</span>
              </div>
              <p className="text-sm text-muted-foreground">
                {t('about.update_downloaded')}
              </p>
              <div className="flex gap-3">
                <Button variant="outline" className="flex-1" onClick={handleClose}>
                  {t('update_dialog.install_later')}
                </Button>
          ...
          {status === 'error' && (
            <>
              <p className="text-sm text-destructive">
                {t('update_dialog.check_failed')}: {error}
              </p>
