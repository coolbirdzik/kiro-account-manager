...
const getMenuItems = (t: any): { id: PageType; label: string; icon: React.ElementType }[] => [
    ...
    >
      ...
      <div className="h-12 flex items-center justify-center border-b px-2 gap-2 overflow-hidden">
        {collapsed ? (
          ...
          <>
            ...
            />
            <span className="font-semibold text-foreground whitespace-nowrap">{t('about.app_name')}</span>
          </>
        )}
      </div>
      ...
      <div className="p-2 border-t">
        <button
          ...
          title={collapsed ? t('common.loading') : t('common.loading')}
        >
          {collapsed ? (
            ...
            <>
              ...
              <span className="whitespace-nowrap">{t('common.close')}</span>
            </>
          )}
        </button>
      </div>
